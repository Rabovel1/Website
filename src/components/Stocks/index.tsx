...
const Stock = () => {
  ...
  return (
    <section
      id="analytics"
      className="py-16 md:py-20 lg:py-28 bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900"
    >
        ...
        <div className="relative overflow-hidden">
          ...
          >
            {stockData.map((stock, index) => (
              <div
                key={index}
                className="relative inline-block rounded-lg border border-gray-200 bg-white p-6 shadow-md transition-all duration-500 hover:-translate-y-2 hover:shadow-lg dark:border-gray-700 dark:bg-gray-800"
              >
