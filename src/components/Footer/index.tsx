...
const Footer = () => {
  return (
    <>
      <footer className="relative z-10 mx-auto bg-white pt-16 pb-3 dark:bg-gray-dark md:pt-20 lg:pt-24">
        ...
        <div className="container mx-auto">
          <p className="text-md-3 p-10 bg-grey-200 font-inter font-semibold text-black dark:text-white justify-center">&copy; 2024 Rabovel. All rights reserved.</p>
        </div>
      </footer>
    </>
  );
